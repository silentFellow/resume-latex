...
\begin{document}
\name{Gowtham S}
\tagline{Tech Enthusiast | Passionate Developer from India | Passionate about Linux, CLI and Open-Source | Crafting Elegant Solutions with Precision ⚡️}
\photo{2.8cm}{profile}
...
\personalinfo{%
  ...
  \href{https://gowtham-portfolio-5idn.onrender.com}{\faGlobe} \hspace{0.5em} | \hspace{0.5em}
